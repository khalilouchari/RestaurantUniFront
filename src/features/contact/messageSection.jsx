...
function MessageSection({ contact }) {
  if (contact)
    return (
      <div className="w-full bg-white shadow-md p-3 flex flex-col space-y-4">
        <div className="text-sm font-semibold">
          {" "}
          Nom : <span className="font-light "> {contact.name}</span>
        </div>
        <div className="text-sm font-semibold">
          {" "}
          Email : <span className="font-light "> {contact.email}</span>
        </div>
        <div className="text-sm font-semibold">
          {" "}
          Telephone : <span className="font-light "> {contact.phone}</span>
        </div>
        <div className="text-sm font-semibold">
          {" "}
          Sujet : <span className="font-light "> {contact.subject}</span>
        </div>
        <div className="text-sm font-semibold"> Message </div>
        <div className="font-light bg-gray-200 p-2 shadow-sm ">
          {" "}
          {contact.message}
        </div>
      </div>
