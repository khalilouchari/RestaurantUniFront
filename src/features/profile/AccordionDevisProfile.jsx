...
function AccordionDevisProfile({ open, handleOpen, index, devis, refetch }) {
  let { handleModal } = useContext(ModalContext);

  const columns = ["image", "ref", "name", "quantity", "price"];
  return (
      ...
      <AccordionBody
        ...
        <div className={"flex flex-col space-y-4"}>
              ...
              <tbody>
                ...
                <tr className=" ">
                  ...
                  <td className="px-6 py-4   border-b border-gray-500  truncate w-20 font-semibold text-gray-800  h-10">
                    {" "}
                    TOTAL PRICE : {devis?.totalDevisPrice}{" "}
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div className="flex justify-end space-x-4">
            ...
            <button
              onClick={() =>
                handleModal(<ModalDevis id={devis._id} refetch={refetch} />)
              }
              className="px-8 mt-4 py-3 hover:no-underline hover:shadow-lg font-semibold rounded  text-white w-fit self-end bg-black flex items-center space-x-3">
...
export default AccordionDevisProfile;
